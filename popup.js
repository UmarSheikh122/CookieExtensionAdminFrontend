                    ...
                    ? ((o.innerHTML = d.origin),
                      ...
                      n.addEventListener("click", () => {
                          try {
                              ...
                              t.filter((e) => e.domain.includes(d.host) || d.host.includes(e.domain)).length > 0 ? a(d) : ((i.style.display = "block"), (r.innerHTML = `Imported cookies are for <strong>${t[0].domain}</strong>`));
                          } catch (e) {
                              (i.style.display = "block"), (r.innerHTML = "⚠️Wrong Key");
                          }
                      }))
                    : ((i.style.display = "block"), (o.innerHTML = "Invalid Domain"), (r.innerHTML = "Invalid Domain"), (t.disabled = !0), (n.disabled = !0));
            });
            const l = (o) => {
                ...
                c = (t) => {
                    ...
                    n.forEach((e) => {
                        (e = JSON.parse(e)),
                            chrome.cookies.set(
                                { url: t.origin, name: e.name, value: e.value, domain: e.domain, path: e.path, secure: e.secure, httpOnly: e.httponly, sameSite: e.sameSite, expirationDate: e.expirationDate, storeId: e.storeId },
                                () => {
                                    o++,
                                        o === n.length &&
